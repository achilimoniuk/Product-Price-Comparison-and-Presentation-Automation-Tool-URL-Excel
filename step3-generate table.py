...
# Contracts
    ...
    ## To be done sfter the analysis
    # number of contracts based on type of List Price issue
 #   df5.loc[len(df5.index)] = [country,
 #   mismatched_listprice['type'].value_counts(),
 #   (mismatched_listprice['type'].value_counts()/mismatched_listprice['type'].count())*100]
...
## to be done after the analysis
#save_doc(df5, 'number of all contracts with List Price issue')
